...
class Settings(BaseSettings):
    ...
    # --- YENİ: Standartlaştırılmış İsimle Çalışma Modu ---
    KNOWLEDGE_SERVICE_APP_MODE: str = Field("HYBRID", validation_alias="KNOWLEDGE_SERVICE_APP_MODE") # HYBRID veya HTTP_ONLY
    ...
    KNOWLEDGE_SERVICE_CERT_PATH: Optional[str] = Field(None, validation_alias="KNOWLEDGE_SERVICE_CERT_PATH")
    KNOWLEDGE_SERVICE_KEY_PATH: Optional[str] = Field(None, validation_alias="KNOWLEDGE_SERVICE_KEY_PATH")
    GRPC_TLS_CA_PATH: Optional[str] = Field(None, validation_alias="GRPC_TLS_CA_PATH")
